    ...
    <section class="flex w-full justify-around py-8">
      ...
      >
        ...
        >
          ...
          <p class="py-1 leading-7">
            ...
            单词和下划线Hiện，代表这部分单词存在某些Lỗi需要更正，此时可按下空格键
            <span class="text-gray-500">（Space ␣）</span>
            快速定位到Thứ nhấtcáiLỗi单词并Xóa tất cả，Hoàn thành更改后再按mộtlần空格Tiếp tục定位到下cái错词
          </p>
          <p class="py-1 leading-7">
            此时若发现上cái错词Chưa正确修改，可按下退格键
          ...
          <p class="py-1 leading-7">
            右上角图标进入 User Info
            切换到Cài đặttrang面，自定义你Thích的快捷键，也可以控制语音是否自动Phát、单词下划线固定长度、使用空格Gửi等等……ThêmcáingườiCài đặt会持续更新
            😊
            <i
      ...
      >
        ...
        >
          ...
          <p class="py-1">每cái句子包含单词/词组/语法，所以学会mộtcái句子后，就可以清晰地表达出来。</p>
          ...
          <p class="py-1 leading-7">循序渐进的增加难度，先从最简单的句型Bắt đầu，再到更加丰富的概念</p>
          <h3 class="pb-2 text-base font-semibold">正向反馈来的快</h3>
          <p class="py-1 leading-7">
            当自己可以写出长难句时，会非常有成就感，所以也会越学越想学。打破了传统且非常痛苦的英语Học tập方案
            ——背单词（还记得 abandon 吗？ oh 不，Bây giờ是 aback 了）
          </p>
        </div>
      </div>
    </section>
