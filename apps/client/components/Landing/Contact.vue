          ...
          <ul class="mt-6 flex gap-6 transition">
            ...
            <li>
               <a
                ...
                > <span class="sr-only">Twitter</span> <span
                  class="icon-link icon-link-gray i-simple-icons-x"
                ></span
                > </a
              >
            </li>
            ...
            <li>
               <a
                ...
                rel="noreferrer"
                target="_blank"
                > <span class="sr-only">Telegram</span> <span
                  class="icon-link icon-link-gray i-simple-icons-telegram"
                ></span
                > </a
              >
            </li>
            ...
            <li>
               <a
                ...
                > <span class="sr-only">GitHub</span> <span
                  class="icon-link icon-link-gray i-simple-icons-github"
                ></span
                > </a
              >
            </li>
