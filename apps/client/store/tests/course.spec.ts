...
const mockCourse = {
  ...
  statements: [
    ...
    { id: "3", order: 3, english: "Test", vietnamese: "Kiểm tra", soundmark: "/test/", isMastered: false },
    {
      id: "4",
      order: 4,
      english: "Unit",
    ...
    { id: "5", order: 5, english: "Case", vietnamese: "Trường hợp", soundmark: "/keɪs/", isMastered: false },
  ],
  coursePackId: "pack1",
  completionCount: 0,
  statementIndex: 0,
